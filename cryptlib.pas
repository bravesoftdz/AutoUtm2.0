...
{------------------------------------------------------------------------------
 ...
 "cryptlib.h" dated Wed Oct  6 21:01:44 2010, filesize = 99136.
...
const
  ...
  CRYPT_SESSINFO_SSH_CHANNEL = 6022;  { SSH current channel }
  CRYPT_SESSINFO_SSH_CHANNEL_TYPE = 6023;  { SSH channel type }
  CRYPT_SESSINFO_SSH_CHANNEL_ARG1 = 6024;  { SSH channel argument 1 }
  CRYPT_SESSINFO_SSH_CHANNEL_ARG2 = 6025;  { SSH channel argument 2 }
  CRYPT_SESSINFO_SSH_CHANNEL_ACTIVE = 6026;  { SSH channel active }
  
  { Used internally }
  CRYPT_SESSINFO_LAST = 6027;  CRYPT_USERINFO_FIRST = 7000;  
